...
require('lazy').setup({
  ...
  require 'kickstart.plugins.git-blame', -- for adding git blame pluggin
  require 'kickstart.plugins.copilot', -- for adding copilot pluggin
  require 'kickstart.plugins.toggleterm', -- for adding toggleterm pluggin'
  require 'kickstart.plugins.lualine', -- for adding nvim-tree pluggin
  require 'kickstart.plugins.commentary', -- for adding commentary pluggin
